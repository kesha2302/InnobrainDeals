...
<div class="mt-3 container">
    ...
    <div class="card mt-2">
        <div class="card-body">
            ...
            <p><strong>Name:</strong> {{ $guser->name }}</p>
            <p><strong>Email:</strong> {{ $guser->email }}</p>

            <h5>Order Details:</h5>
            <p><strong>Order ID:</strong> {{ $order->guestorder_id }}</p>
                            ...
                            <td>
                                ...
                                @else
                                    <a class="btn btn-primary"
                                       href="{{ route('send.guestactivation', ['orderId' => $order->guestorder_id, 'productId' => $product['id']]) }}"
                                       role="button">
